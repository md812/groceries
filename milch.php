  ...
  <div class="small-container">
    ...
    <div class="row">
      <div class="col-4">
        ...
        <h3><?php echo "{$rows[0]['price']}" . "€ pro 1l"; ?></h3>
      ...
      <div class="col-4">
        ...
        <h3><?php echo "{$rows[1]['price']}" . "€ pro 1l"; ?></h3>
      ...
      <div class="col-4">
        ...
        <h3><?php echo "{$rows[2]['price']}" . "€ pro 1l"; ?></h3>
      ...
      <div class="col-4">
        ...
        <h3><?php echo "{$rows[3]['price']}" . "€ pro 1l"; ?></h3>
      ...
      <div class="col-4">
        ...
        <h3><?php echo "{$rows[4]['price']}" . "€ pro 1l"; ?></h3>
      ...
      <div class="col-4">
        ...
        <h3><?php echo "{$rows[5]['price']}" . "€ pro 1l"; ?></h3>
      ...
      <div class="col-4">
        ...
        <h3><?php echo "{$rows[6]['price']}" . "€ pro 1l"; ?></h3>
      ...
      <div class="col-4">
        ...
        <h3><?php echo "{$rows[7]['price']}" . "€ pro 1l"; ?></h3>
      ...
      <div class="col-4">
        ...
        <h3><?php echo "{$rows[8]['price']}" . "€ pro 1l"; ?></h3>
      ...
      <div class="col-4">
        ...
        <h3><?php echo "{$rows[9]['price']}" . "€ pro 1l"; ?></h3>
      ...
      <div class="col-4">
        ...
        <h3><?php echo "{$rows[10]['price']}" . "€ pro 1l"; ?></h3>
      ...
      <div class="col-4">
        ...
        <h3><?php echo "{$rows[11]['price']}" . "€ pro 1l"; ?></h3>
